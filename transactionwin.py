...
class Transactionwin:
    ...
    def __init__(self, args: dict):
        ...
        self.generator_location: string = str(args.get("generator_location",
            f"{os.environ['USERPROFILE']}/workspace/column-level-encryption/Sparkov_Data_Generation"))
        self.data_folder: string = str(args.get("data_folder",
            f"{os.environ['USERPROFILE']}/workspace/column-level-encryption/data/generated"))
